...
'Mithrandir - Configura tu IP debajo ^^
Public Const EAOipserver As String = "127.0.0.1"
Public Const EAOportserver As Integer = "7666"

'Objetos públicos
Public sckMstatus As String
Public ServerGH As String
Public Cheating As Boolean
Public FramesCaballo As Integer
Public MSNshow As Byte
Public SoyGM As Byte
Public MyGuildName As String
Public PuedoVerClan As Byte
...
Public mF1 As String
Public mF2 As String
Public mF3 As String
Public mF6 As String
Public mF7 As String
Public mF8 As String
Public mF9 As String

Public Const CRYPTO_PASS As String = "PA"

'Public Const SoyEric As Boolean = True

Public cuentaNom As String
Public cuentaPass As String
Public cuentaEmail As String

Public ClienteMD5 As String

Public VeoMapa As Boolean
Public VeoPergamino As Boolean

#If SeguridadAlkon Then
Public md5 As New clsMD5
#End If

Public nightEffect As Boolean
Public userMontando As Boolean

Public IntervaloPaso As Single
Public LastPaso As Single

'Public Const INTERVALOCABALLO As Single = 0.13
'Public Const INTERVALOWALK As Single = 0.17

Public Const INTERVALOCABALLO As Single = 0.17
Public Const INTERVALOWALK As Single = 0.21

'Sonidos
Public Const SND_CLICK As String = "click.Wav"
Public Const SND_PASOS1 As String = "23.Wav"
Public Const SND_GALOPE As String = "52.wav"
...
Public ServerEAO As String
Public PuertoEAO As Integer

Public CreandoClan As Boolean
Public ClanName As String
Public Site As String

'Public RcbWeightTotal As Double
'Public RcbWeight As Double
...
Public verifUser As String
Public verifCode As String
...
Public recoveryAccount As String
Public recoveryMail As String
