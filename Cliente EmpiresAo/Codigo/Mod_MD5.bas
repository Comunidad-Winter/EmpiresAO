...
'
Public Function MD5String(SourceString As String) As String
    MD5Init
    MD5Update Len(SourceString), StringToArray(SourceString)
    MD5Final
    MD5String = LCase(GetValues)
End Function
...
Private Sub Decode(Length As Long, OutputBuffer() As Long, InputBuffer() As Byte)
