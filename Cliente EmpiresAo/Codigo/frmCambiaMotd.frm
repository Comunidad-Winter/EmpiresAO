...
Begin VB.Form frmCambiaMotd 
   ...
   MaxButton       =   0   'False
   MinButton       =   0   'False
   MouseIcon       =   "frmCambiaMotd.frx":0000
   ...
   Begin VB.CommandButton cmdMarron 
      ...
      Height          =   375
      Left            =   3480
      MouseIcon       =   "frmCambiaMotd.frx":0CCA
      MousePointer    =   99  'Custom
      TabIndex        =   10
      Top             =   3840
      Width           =   855
   ...
   Begin VB.CommandButton cmdVerde 
      ...
      Height          =   375
      Left            =   2520
      MouseIcon       =   "frmCambiaMotd.frx":1994
      MousePointer    =   99  'Custom
      TabIndex        =   9
      Top             =   3840
      Width           =   855
   ...
   Begin VB.CommandButton cmdMorado 
      ...
      Height          =   375
      Left            =   1560
      MouseIcon       =   "frmCambiaMotd.frx":265E
      MousePointer    =   99  'Custom
      TabIndex        =   8
      Top             =   3840
      Width           =   855
   ...
   Begin VB.CommandButton cmdAmarillo 
      ...
      Height          =   375
      Left            =   600
      MouseIcon       =   "frmCambiaMotd.frx":3328
      MousePointer    =   99  'Custom
      TabIndex        =   7
      Top             =   3840
      Width           =   855
   ...
   Begin VB.CommandButton cmdGris 
      ...
      Height          =   375
      Left            =   3480
      MouseIcon       =   "frmCambiaMotd.frx":3FF2
      MousePointer    =   99  'Custom
      TabIndex        =   6
      Top             =   3240
      Width           =   855
   ...
   Begin VB.CommandButton cmdBlanco 
      ...
      Height          =   375
      Left            =   2520
      MouseIcon       =   "frmCambiaMotd.frx":4CBC
      MousePointer    =   99  'Custom
      TabIndex        =   5
      Top             =   3240
      Width           =   855
   ...
   Begin VB.CommandButton cmdRojo 
      ...
      Height          =   375
      Left            =   1560
      MouseIcon       =   "frmCambiaMotd.frx":5986
      MousePointer    =   99  'Custom
      TabIndex        =   4
      Top             =   3240
      Width           =   855
   ...
   Begin VB.CommandButton cmdAzul 
      ...
      Left            =   600
      MaskColor       =   &H00FF0000&
      MouseIcon       =   "frmCambiaMotd.frx":6650
      MousePointer    =   99  'Custom
      TabIndex        =   3
      Top             =   3240
      Width           =   855
   ...
   Begin VB.CommandButton cmdOk 
      ...
      Height          =   375
      Left            =   600
      MouseIcon       =   "frmCambiaMotd.frx":731A
      MousePointer    =   99  'Custom
      TabIndex        =   2
      Top             =   4800
      Width           =   3855
