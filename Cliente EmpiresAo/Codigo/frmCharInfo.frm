...
Begin VB.Form frmCharInfo 
   ...
   Begin VB.CommandButton desc 
      ...
      Height          =   495
      Left            =   2655
      MouseIcon       =   "frmCharInfo.frx":0CCA
      MousePointer    =   99  'Custom
      TabIndex        =   14
      Top             =   5625
      Width           =   1000
   ...
   Begin VB.CommandButton Echar 
      ...
      Height          =   495
      Left            =   1395
      MouseIcon       =   "frmCharInfo.frx":1994
      MousePointer    =   99  'Custom
      TabIndex        =   13
      Top             =   5625
      Width           =   1000
   ...
   Begin VB.CommandButton Aceptar 
      ...
      Height          =   495
      Left            =   5085
      MouseIcon       =   "frmCharInfo.frx":265E
      MousePointer    =   99  'Custom
      TabIndex        =   12
      Top             =   5625
      Width           =   1000
   ...
   Begin VB.CommandButton Rechazar 
      ...
      Height          =   495
      Left            =   3870
      MouseIcon       =   "frmCharInfo.frx":3328
      MousePointer    =   99  'Custom
      TabIndex        =   11
      Top             =   5625
      Width           =   1000
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   495
      Left            =   120
      MouseIcon       =   "frmCharInfo.frx":3FF2
      MousePointer    =   99  'Custom
      TabIndex        =   10
      Top             =   5625
      Width           =   1000
