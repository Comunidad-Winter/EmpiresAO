...
Begin VB.Form frmGuildLeader 
   ...
   Begin VB.CommandButton Command9 
      ...
      Height          =   495
      Left            =   3000
      MouseIcon       =   "frmGuildLeader.frx":0CCA
      MousePointer    =   99  'Custom
      TabIndex        =   17
      Top             =   5460
      Width           =   2775
   ...
   Begin VB.CommandButton Command8 
      ...
      Height          =   495
      Left            =   3000
      MouseIcon       =   "frmGuildLeader.frx":1994
      MousePointer    =   99  'Custom
      TabIndex        =   15
      Top             =   5970
      Width           =   2775
   ...
   Begin VB.CommandButton Command7 
      ...
      Height          =   495
      Left            =   3000
      MouseIcon       =   "frmGuildLeader.frx":265E
      MousePointer    =   99  'Custom
      TabIndex        =   14
      Top             =   4950
      Width           =   2775
   ...
   Begin VB.CommandButton Command6 
      ...
      Height          =   495
      Left            =   3000
      MouseIcon       =   "frmGuildLeader.frx":3328
      MousePointer    =   99  'Custom
      TabIndex        =   13
      Top             =   4440
      Width           =   2775
   ...
   Begin VB.CommandButton Command5 
      ...
      Height          =   495
      Left            =   3000
      MouseIcon       =   "frmGuildLeader.frx":3FF2
      MousePointer    =   99  'Custom
      TabIndex        =   12
      Top             =   3930
      Width           =   2775
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ListBox guildslist 
         Height          =   1425
         ItemData        =   "frmGuildLeader.frx":4CBC
         Left            =   120
         List            =   "frmGuildLeader.frx":4CBE
         TabIndex        =   11
         Top             =   240
         Width           =   2655
      End
      Begin VB.CommandButton Command4 
         ...
         Height          =   375
         Left            =   120
         MouseIcon       =   "frmGuildLeader.frx":4CC0
         MousePointer    =   99  'Custom
         TabIndex        =   10
         Top             =   1800
         Width           =   2655
   ...
   Begin VB.Frame txtnews 
      ...
      Begin VB.CommandButton Command3 
         ...
         Height          =   375
         Left            =   120
         MouseIcon       =   "frmGuildLeader.frx":598A
         MousePointer    =   99  'Custom
         TabIndex        =   8
         Top             =   1080
         Width           =   5535
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   375
         Left            =   120
         MouseIcon       =   "frmGuildLeader.frx":6654
         MousePointer    =   99  'Custom
         TabIndex        =   5
         Top             =   1800
         Width           =   2655
      ...
      Begin VB.ListBox members 
         Height          =   1425
         ItemData        =   "frmGuildLeader.frx":731E
         Left            =   120
         List            =   "frmGuildLeader.frx":7320
         TabIndex        =   4
         Top             =   240
         Width           =   2655
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdElecciones 
         ...
         Height          =   375
         Left            =   120
         MouseIcon       =   "frmGuildLeader.frx":7322
         MousePointer    =   99  'Custom
         TabIndex        =   18
         Top             =   1935
         Width           =   2655
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   375
         Left            =   120
         MouseIcon       =   "frmGuildLeader.frx":7FEC
         MousePointer    =   99  'Custom
         TabIndex        =   2
         Top             =   1170
         Width           =   2655
      ...
      Begin VB.ListBox solicitudes 
         Height          =   840
         ItemData        =   "frmGuildLeader.frx":8CB6
         Left            =   120
         List            =   "frmGuildLeader.frx":8CB8
         TabIndex        =   1
         Top             =   240
         Width           =   2655
      End
