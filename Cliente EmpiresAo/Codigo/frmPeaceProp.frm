...
Begin VB.Form frmPeaceProp 
   ...
   Begin VB.CommandButton Command4 
      ...
      Height          =   495
      Left            =   3720
      MouseIcon       =   "frmPeaceProp.frx":0CCA
      MousePointer    =   99  'Custom
      TabIndex        =   4
      Top             =   2280
      Width           =   975
   ...
   Begin VB.CommandButton Command3 
      ...
      Height          =   495
      Left            =   2520
      MouseIcon       =   "frmPeaceProp.frx":1994
      MousePointer    =   99  'Custom
      TabIndex        =   3
      Top             =   2280
      Width           =   975
   ...
   Begin VB.CommandButton Command2 
      ...
      Height          =   495
      Left            =   1320
      MouseIcon       =   "frmPeaceProp.frx":265E
      MousePointer    =   99  'Custom
      TabIndex        =   2
      Top             =   2280
      Width           =   975
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   495
      Left            =   120
      MouseIcon       =   "frmPeaceProp.frx":3328
      MousePointer    =   99  'Custom
      TabIndex        =   1
      Top             =   2280
      Width           =   975
   ...
   Begin VB.ListBox lista 
      ...
      EndProperty
      Height          =   2010
      ItemData        =   "frmPeaceProp.frx":3FF2
      Left            =   120
      List            =   "frmPeaceProp.frx":3FF4
      TabIndex        =   0
      Top             =   120
      Width           =   4695
   End
