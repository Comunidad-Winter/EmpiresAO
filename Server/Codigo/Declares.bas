...
Public PosisX As Integer
Public PosisY As Integer

Public transferTotal As Long
Public transferTotalMax As Long
Public MixedKey As Long
Public ServerIp As String
Public ServerNombre As String
Public ServerWeb As String
Public CrcSubKey As String
Public cNoche As Boolean
Public sGlobal As Boolean

Public wskSmtpStatus(91) As Boolean

Public ssMail As String
Public vldtCode As String

Public RndValidateCode As String

Public rndVltPss As String
...
Public Const CRYPTO_PASS As String = "PA"

Public LastNeedProcess As Integer

Public castNorte As String
Public castSur As String
Public castOeste As String
Public castEste As String

Public cAvisado As ccCastillos
Public ccAvisado As ccCastillos

Public Type ccCastillos
    Norte As Integer
    Sur As Integer
    Oeste As Integer
    Este As Integer
...
Public lastClan As lstClanCast

Public Type lstClanCast
    Norte As String
    Sur As String
    Oeste As String
    Este As String
...
Public clanGuildIndex As Integer


Public MiCabecera As tCabecera

Public AvisosTodos As Variant
Public AvisosClan As Variant
...
Public Const STAT_MAXHP As Integer = 600
...
Public Type Inventario
    ...
    CaballoEqpObjIndex As Integer
    CaballoEqpSlot As Integer
    BarcoObjIndex As Integer
    BarcoSlot As Byte
    NroItems As Integer
    'Weight As Variant
    'TotalWeight As Variant
End Type
...
Public MailDomain As String
Public UserSMTP As String
Public PassSMTP As String
Public SMTP0 As Boolean
Public SMTP1 As Boolean
