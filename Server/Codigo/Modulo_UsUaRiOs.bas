...
'Lo mata
Call SendData(SendTarget.ToIndex, AttackerIndex, 0, "PRB8," & UserList(VictimIndex).name)
Call SendData(SendTarget.ToIndex, AttackerIndex, 0, "PRB4," & DaExp)
      
Call SendData(SendTarget.ToIndex, VictimIndex, 0, "PRB9," & UserList(AttackerIndex).name)

If UserList(VictimIndex).flags.EnDuelo = 1 And UserList(AttackerIndex).flags.EnDuelo = 1 Then
...
If VictimIndex = GranPoder Then
    Call SendData(SendTarget.ToAll, 0, 0, "PRE11," & UserList(VictimIndex).name)
...
Sub ChangeUserChar(ByVal sndRoute As Byte, ByVal sndIndex As Integer, ByVal sndMap As Integer, ByVal UserIndex As Integer, _
    ...
    Crypted = "CP" & UserList(UserIndex).Char.CharIndex & "," & Body & "," & Head & "," & Heading & "," & Arma & "," & Escudo & "," & UserList(UserIndex).Char.FX & "," & UserList(UserIndex).Char.loops & "," & Casco & "," & UserList(UserIndex).flags.Montado
    
    If sndRoute = SendTarget.ToMap Then
        Call SendToUserArea(UserIndex, "ç" & Encrypt_PRO(Crypted, CRYPTO_PASS)) '"CP" & UserList(UserIndex).Char.CharIndex & "," & Body & "," & Head & "," & Heading & "," & Arma & "," & Escudo & "," & UserList(UserIndex).Char.FX & "," & UserList(UserIndex).Char.loops & "," & Casco & "," & UserList(UserIndex).flags.Montado)
    Else
        Call SendData(sndRoute, sndIndex, sndMap, "ç" & Encrypt_PRO(Crypted, CRYPTO_PASS)) '"CP" & UserList(UserIndex).Char.CharIndex & "," & Body & "," & Head & "," & Heading & "," & Arma & "," & Escudo & "," & UserList(UserIndex).Char.FX & "," & UserList(UserIndex).Char.loops & "," & Casco & "," & UserList(UserIndex).flags.Montado)
    End If
End Sub
...
#End If
                    If UserList(UserIndex).flags.Privilegios > PlayerType.User Then
                        If UserList(UserIndex).showName Then
                            Crypted = "CC" & UserList(UserIndex).Char.Body & "," & UserList(UserIndex).Char.Head & "," & UserList(UserIndex).Char.Heading & "," & UserList(UserIndex).Char.CharIndex & "," & X & "," & Y & "," & UserList(UserIndex).Char.WeaponAnim & "," & UserList(UserIndex).Char.ShieldAnim & "," & UserList(UserIndex).Char.FX & "," & 999 & "," & UserList(UserIndex).Char.CascoAnim & "," & UserList(UserIndex).name & " <" & klan & ">" & "," & bCr & "," & IIf(UserList(UserIndex).flags.EsRolesMaster, 5, UserList(UserIndex).flags.Privilegios) & "," & UserList(UserIndex).flags.Montado & "," & UserList(UserIndex).flags.Invisible
                            Call SendData(sndRoute, sndIndex, sndMap, "ç" & Encrypt_PRO(Crypted, CRYPTO_PASS)) '"CC" & UserList(UserIndex).Char.Body & "," & UserList(UserIndex).Char.Head & "," & UserList(UserIndex).Char.Heading & "," & UserList(UserIndex).Char.CharIndex & "," & X & "," & Y & "," & UserList(UserIndex).Char.WeaponAnim & "," & UserList(UserIndex).Char.ShieldAnim & "," & UserList(UserIndex).Char.FX & "," & 999 & "," & UserList(UserIndex).Char.CascoAnim & "," & UserList(UserIndex).name & " <" & klan & ">" & "," & bCr & "," & IIf(UserList(UserIndex).flags.EsRolesMaster, 5, UserList(UserIndex).flags.Privilegios) & "," & UserList(UserIndex).flags.Montado)
                        Else
                            'Hide the name and clan
                            Crypted = "CC" & UserList(UserIndex).Char.Body & "," & UserList(UserIndex).Char.Head & "," & UserList(UserIndex).Char.Heading & "," & UserList(UserIndex).Char.CharIndex & "," & X & "," & Y & "," & UserList(UserIndex).Char.WeaponAnim & "," & UserList(UserIndex).Char.ShieldAnim & "," & UserList(UserIndex).Char.FX & "," & 999 & "," & UserList(UserIndex).Char.CascoAnim & ",," & bCr & "," & IIf(UserList(UserIndex).flags.EsRolesMaster, 5, UserList(UserIndex).flags.Privilegios) & "," & UserList(UserIndex).flags.Montado & "," & UserList(UserIndex).flags.Invisible
                            Call SendData(sndRoute, sndIndex, sndMap, "ç" & Encrypt_PRO(Crypted, CRYPTO_PASS)) '"CC" & UserList(UserIndex).Char.Body & "," & UserList(UserIndex).Char.Head & "," & UserList(UserIndex).Char.Heading & "," & UserList(UserIndex).Char.CharIndex & "," & X & "," & Y & "," & UserList(UserIndex).Char.WeaponAnim & "," & UserList(UserIndex).Char.ShieldAnim & "," & UserList(UserIndex).Char.FX & "," & 999 & "," & UserList(UserIndex).Char.CascoAnim & ",," & bCr & "," & IIf(UserList(UserIndex).flags.EsRolesMaster, 5, UserList(UserIndex).flags.Privilegios) & "," & UserList(UserIndex).flags.Montado)
                        End If
                    Else
                        Crypted = "CC" & UserList(UserIndex).Char.Body & "," & UserList(UserIndex).Char.Head & "," & UserList(UserIndex).Char.Heading & "," & UserList(UserIndex).Char.CharIndex & "," & X & "," & Y & "," & UserList(UserIndex).Char.WeaponAnim & "," & UserList(UserIndex).Char.ShieldAnim & "," & UserList(UserIndex).Char.FX & "," & 999 & "," & UserList(UserIndex).Char.CascoAnim & "," & UserList(UserIndex).name & " <" & klan & ">" & "," & bCr & "," & IIf(UserList(UserIndex).flags.PertAlCons = 1, 4, IIf(UserList(UserIndex).flags.PertAlConsCaos = 1, 6, 0)) & "," & UserList(UserIndex).flags.Montado & "," & UserList(UserIndex).flags.Invisible
                        Call SendData(sndRoute, sndIndex, sndMap, "ç" & Encrypt_PRO(Crypted, CRYPTO_PASS)) '"CC" & UserList(UserIndex).Char.Body & "," & UserList(UserIndex).Char.Head & "," & UserList(UserIndex).Char.Heading & "," & UserList(UserIndex).Char.CharIndex & "," & X & "," & Y & "," & UserList(UserIndex).Char.WeaponAnim & "," & UserList(UserIndex).Char.ShieldAnim & "," & UserList(UserIndex).Char.FX & "," & 999 & "," & UserList(UserIndex).Char.CascoAnim & "," & UserList(UserIndex).name & " <" & klan & ">" & "," & bCr & "," & IIf(UserList(UserIndex).flags.PertAlCons = 1, 4, IIf(UserList(UserIndex).flags.PertAlConsCaos = 1, 6, 0)) & "," & UserList(UserIndex).flags.Montado)
                    End If
#If SeguridadAlkon Then
                End If
#End If
...
#End If
                    If UserList(UserIndex).flags.Privilegios > PlayerType.User Then
                        If UserList(UserIndex).showName Then
                            Crypted = "CC" & UserList(UserIndex).Char.Body & "," & UserList(UserIndex).Char.Head & "," & UserList(UserIndex).Char.Heading & "," & UserList(UserIndex).Char.CharIndex & "," & X & "," & Y & "," & UserList(UserIndex).Char.WeaponAnim & "," & UserList(UserIndex).Char.ShieldAnim & "," & UserList(UserIndex).Char.FX & "," & 999 & "," & UserList(UserIndex).Char.CascoAnim & "," & UserList(UserIndex).name & "," & bCr & "," & IIf(UserList(UserIndex).flags.EsRolesMaster, 5, UserList(UserIndex).flags.Privilegios) & "," & UserList(UserIndex).flags.Montado
                            Call SendData(SendTarget.ToIndex, sndIndex, sndMap, "ç" & Encrypt_PRO(Crypted, CRYPTO_PASS)) '"CC" & UserList(UserIndex).Char.Body & "," & UserList(UserIndex).Char.Head & "," & UserList(UserIndex).Char.Heading & "," & UserList(UserIndex).Char.CharIndex & "," & X & "," & Y & "," & UserList(UserIndex).Char.WeaponAnim & "," & UserList(UserIndex).Char.ShieldAnim & "," & UserList(UserIndex).Char.FX & "," & 999 & "," & UserList(UserIndex).Char.CascoAnim & "," & UserList(UserIndex).name & "," & bCr & "," & IIf(UserList(UserIndex).flags.EsRolesMaster, 5, UserList(UserIndex).flags.Privilegios) & "," & UserList(UserIndex).flags.Montado)
                        Else
                            Crypted = "CC" & UserList(UserIndex).Char.Body & "," & UserList(UserIndex).Char.Head & "," & UserList(UserIndex).Char.Heading & "," & UserList(UserIndex).Char.CharIndex & "," & X & "," & Y & "," & UserList(UserIndex).Char.WeaponAnim & "," & UserList(UserIndex).Char.ShieldAnim & "," & UserList(UserIndex).Char.FX & "," & 999 & "," & UserList(UserIndex).Char.CascoAnim & ",," & bCr & "," & IIf(UserList(UserIndex).flags.EsRolesMaster, 5, UserList(UserIndex).flags.Privilegios) & "," & UserList(UserIndex).flags.Montado
                            Call SendData(SendTarget.ToIndex, sndIndex, sndMap, "ç" & Encrypt_PRO(Crypted, CRYPTO_PASS)) '"CC" & UserList(UserIndex).Char.Body & "," & UserList(UserIndex).Char.Head & "," & UserList(UserIndex).Char.Heading & "," & UserList(UserIndex).Char.CharIndex & "," & X & "," & Y & "," & UserList(UserIndex).Char.WeaponAnim & "," & UserList(UserIndex).Char.ShieldAnim & "," & UserList(UserIndex).Char.FX & "," & 999 & "," & UserList(UserIndex).Char.CascoAnim & ",," & bCr & "," & IIf(UserList(UserIndex).flags.EsRolesMaster, 5, UserList(UserIndex).flags.Privilegios) & "," & UserList(UserIndex).flags.Montado)
                        End If
                    Else
                        Crypted = "CC" & UserList(UserIndex).Char.Body & "," & UserList(UserIndex).Char.Head & "," & UserList(UserIndex).Char.Heading & "," & UserList(UserIndex).Char.CharIndex & "," & X & "," & Y & "," & UserList(UserIndex).Char.WeaponAnim & "," & UserList(UserIndex).Char.ShieldAnim & "," & UserList(UserIndex).Char.FX & "," & 999 & "," & UserList(UserIndex).Char.CascoAnim & "," & UserList(UserIndex).name & "," & bCr & "," & IIf(UserList(UserIndex).flags.PertAlCons = 1, 4, IIf(UserList(UserIndex).flags.PertAlConsCaos = 1, 6, 0)) & "," & UserList(UserIndex).flags.Montado
                        Call SendData(SendTarget.ToIndex, sndIndex, sndMap, "ç" & Encrypt_PRO(Crypted, CRYPTO_PASS)) '"CC" & UserList(UserIndex).Char.Body & "," & UserList(UserIndex).Char.Head & "," & UserList(UserIndex).Char.Heading & "," & UserList(UserIndex).Char.CharIndex & "," & X & "," & Y & "," & UserList(UserIndex).Char.WeaponAnim & "," & UserList(UserIndex).Char.ShieldAnim & "," & UserList(UserIndex).Char.FX & "," & 999 & "," & UserList(UserIndex).Char.CascoAnim & "," & UserList(UserIndex).name & "," & bCr & "," & IIf(UserList(UserIndex).flags.PertAlCons = 1, 4, IIf(UserList(UserIndex).flags.PertAlConsCaos = 1, 6, 0)) & "," & UserList(UserIndex).flags.Montado)
                    End If
#If SeguridadAlkon Then
                End If
#End If
...
Do While UserList(UserIndex).Stats.Exp >= UserList(UserIndex).Stats.ELU
    ...
    Call SendData(SendTarget.ToIndex, UserIndex, 0, "PRB10")
    ...
    Call SendData(SendTarget.ToIndex, UserIndex, 0, "PRB11," & Pts)
    ...
    'Notificamos al user
    If AumentoHP > 0 Then SendData SendTarget.ToIndex, UserIndex, 0, "PRB12," & AumentoHP
    If AumentoSTA > 0 Then SendData SendTarget.ToIndex, UserIndex, 0, "PRB13," & AumentoSTA
    If AumentoMANA > 0 Then SendData SendTarget.ToIndex, UserIndex, 0, "PRB14," & AumentoMANA
    If AumentoHIT > 0 Then
        SendData SendTarget.ToIndex, UserIndex, 0, "PRB15," & AumentoHIT
        SendData SendTarget.ToIndex, UserIndex, 0, "PRB16," & AumentoHIT
    End If
...
#Else
            Crypted = "+" & UserList(UserIndex).Char.CharIndex & "," & nPos.X & "," & nPos.Y
            Call SendToUserAreaButindex(UserIndex, "ç" & Encrypt_PRO(Crypted, CRYPTO_PASS)) '"+" & UserList(UserIndex).Char.CharIndex & "," & nPos.X & "," & nPos.Y)
#End If
        End If
...
Dim ssObj As Variant
    ...
    If Object.ObjIndex > 0 Then
        ...
        'ssObj = (Object.Amount * ObjData(Object.ObjIndex).oWeight)
        'UserList(UserIndex).Invent.Weight = UserList(UserIndex).Invent.Weight + ssObj
        
        'Call SendUserWeight(UserIndex)
...
Sub SendUserExp(ByVal UserIndex As Integer)
    Call SendData(SendTarget.ToIndex, UserIndex, 0, "EXP" & UserList(UserIndex).Stats.ELU & "," & UserList(UserIndex).Stats.Exp)
End Sub
...
Sub SendUserGold(ByVal UserIndex As Integer)
    Call SendData(SendTarget.ToIndex, UserIndex, 0, "GDL" & UserList(UserIndex).Stats.GLD)
End Sub

Sub SendUserWeight(ByVal UserIndex As Integer)
    'Call SendData(SendTarget.ToIndex, UserIndex, 0, "WEG" & (UserList(UserIndex).Invent.Weight / 1000) & "@" & (UserList(UserIndex).Invent.TotalWeight / 1000))
End Sub

Sub SendUserEqp(ByVal UserIndex As Integer)

If UserList(UserIndex).Invent.ArmourEqpObjIndex > 0 Then
    Call SendData(SendTarget.ToIndex, UserIndex, 0, "AAR" & ObjData(UserList(UserIndex).Invent.ArmourEqpObjIndex).MinDef & "," & ObjData(UserList(UserIndex).Invent.ArmourEqpObjIndex).MaxDef)
Else
    Call SendData(SendTarget.ToIndex, UserIndex, 0, "AAR0,0")
End If

If UserList(UserIndex).Invent.CascoEqpObjIndex > 0 Then
    Call SendData(SendTarget.ToIndex, UserIndex, 0, "CZC" & ObjData(UserList(UserIndex).Invent.CascoEqpObjIndex).MinDef & "," & ObjData(UserList(UserIndex).Invent.CascoEqpObjIndex).MaxDef)
Else
    Call SendData(SendTarget.ToIndex, UserIndex, 0, "CZC0,0")
End If

If UserList(UserIndex).Invent.EscudoEqpObjIndex > 0 Then
    Call SendData(SendTarget.ToIndex, UserIndex, 0, "SHD" & ObjData(UserList(UserIndex).Invent.EscudoEqpObjIndex).MinDef & "," & ObjData(UserList(UserIndex).Invent.EscudoEqpObjIndex).MaxDef)
Else
    Call SendData(SendTarget.ToIndex, UserIndex, 0, "SHD0,0")
End If

If UserList(UserIndex).Invent.WeaponEqpObjIndex > 0 Then
    Call SendData(SendTarget.ToIndex, UserIndex, 0, "WEP" & ObjData(UserList(UserIndex).Invent.WeaponEqpObjIndex).MinHIT & "," & ObjData(UserList(UserIndex).Invent.WeaponEqpObjIndex).MaxHIT)
Else
    Call SendData(SendTarget.ToIndex, UserIndex, 0, "WEP0,0")
End If
...
Public Sub LogPuedeAprender(ByVal texto As String)
'*************************************************
...
On Error GoTo errhandler
    ...
    Open App.Path & "\logs\PuedeAprender.log" For Append Shared As #nfile
...
Public Sub UserPuedeAprender(ByVal UserIndex As Integer)

If UserList(UserIndex).flags.PuedeAprender = 0 Then
    UserList(UserIndex).flags.PuedeAprender = 1
    Call SendData(SendTarget.ToIndex, UserIndex, 0, "PRB34")
    Call LogPuedeAprender(UserList(UserIndex).name & " puede aprender hechizos para clase.")
End If
...
If Npclist(NpcIndex).NPCtype <> eNPCType.ReydelCastillo Then
...
If UserList(UserIndex).flags.Hambre = 0 And _
   UserList(UserIndex).flags.Sed = 0 Then
    ...
    If Aumenta = 2 And UserList(UserIndex).Stats.UserSkills(Skill) < LevelSkill(lvl).LevelValue Then
        UserList(UserIndex).Stats.UserSkills(Skill) = UserList(UserIndex).Stats.UserSkills(Skill) + 1
        Call SendData(SendTarget.ToIndex, UserIndex, 0, "PRT11," & SkillsNames(Skill) & "," & UserList(UserIndex).Stats.UserSkills(Skill))
        ...
        Call SendData(SendTarget.ToIndex, UserIndex, 0, "PRB17")
...
On Error GoTo ErrorHandler
    ...
    If UserList(UserIndex).flags.Montado = 1 Then
        ...
        Call SendData(SendTarget.ToIndex, UserIndex, 0, "MONTA0")
        Call Desequipar(UserIndex, UserList(UserIndex).Invent.CaballoEqpSlot)
    End If
    ...
    For i = 1 To MAXMASCOTAS
        ...
        If UserList(UserIndex).MascotasIndex(i) > 0 Then
               If Npclist(UserList(UserIndex).MascotasIndex(i)).Contadores.TiempoExistencia > 0 Or _
               (UserList(UserIndex).MascotasIndex(i) = UserList(UserIndex).Pet.Index And UserList(UserIndex).Pet.Invocada) Then
...
Dim OldY As Integer
    ...
    If LegalPos(Map, X, Y) = False Then
        If ChangeIlegalPos(Map, X, Y) = True Then
            X = PosisX
            Y = PosisY
        End If
  End If
    ...
    If OldMap <> Map Then
        Call SendData(SendTarget.ToIndex, UserIndex, 0, "CM" & Map & "," & MapInfo(Map).MapVersion & "," & MapInfo(Map).name)
    ...
    Call SendData(SendTarget.ToIndex, UserIndex, 0, "ç" & Encrypt_PRO("IP" & UserList(UserIndex).Char.CharIndex, CRYPTO_PASS))
    ...
    If (UserList(UserIndex).flags.Invisible = 1 Or UserList(UserIndex).flags.Oculto = 1) And (Not UserList(UserIndex).flags.AdminInvisible = 1) Then
       ...
       ' If Guilds(UserList(UserIndex).GuildIndex).GuildName <> "" Then Call SendData(SendTarget.toguildmembers, UserIndex, UserList(UserIndex).Pos.Map, "PUDVE" & UserList(UserIndex).Char.CharIndex & ",1")
    End If
    ...
    If UserList(UserIndex).flags.EnDuelo = 1 Then Call AbandonarDuelo(UserIndex)
...
Function ChangeIlegalPos(ByVal Map As Integer, X As Integer, Y As Integer) As Boolean
...
For tInt = 1 To 5
    For i = X - tInt To X + tInt
        For o = Y - tInt To Y + tInt
            If MapData(Map, i, o).UserIndex = 0 And LegalPos(Map, i, o) = True Then
                PosisX = i
                PosisY = o
                ChangeIlegalPos = True
                Exit Function
            End If
        Next o
    Next i
...
#End If
                If UserList(MapData(Map, X, Y).UserIndex).flags.Invisible = 1 Or UserList(MapData(Map, X, Y).UserIndex).flags.Oculto = 1 Then
                    Crypted = "NOVER" & UserList(MapData(Map, X, Y).UserIndex).Char.CharIndex & ",1"
                    Call SendData(SendTarget.ToIndex, UserIndex, 0, "ç" & Encrypt_PRO(Crypted, CRYPTO_PASS)) '"NOVER" & UserList(MapData(Map, X, Y).UserIndex).Char.CharIndex & ",1")
                    'If Guilds(UserList(MapData(Map, X, Y).UserIndex).GuildIndex).GuildName <> "" Then Call SendData(SendTarget.toguildmembers, UserIndex, UserList(UserIndex).Pos.Map, "PUDVE" & UserList(MapData(Map, X, Y).UserIndex).Char.CharIndex & ",1")
                End If
...
Dim PetIndexs(1 To MAXMASCOTAS) As Integer
...
InvocadosMatados = 0
    ...
    For i = 1 To MAXMASCOTAS
        If UserList(UserIndex).MascotasIndex(i) > 0 Then
            ...
            If Npclist(UserList(UserIndex).MascotasIndex(i)).Contadores.TiempoExistencia > 0 Or EstaEnCastillo(UserIndex) = True Then
    ...
    If InvocadosMatados > 0 Then
        Call SendData(SendTarget.ToIndex, UserIndex, 0, "PRB18")
    End If
    ...
    For i = 1 To MAXMASCOTAS
        If PetTypes(i) > 0 Then
            ...
            If UserList(UserIndex).MascotasIndex(i) = 0 Then
                ...
                Exit Sub
            End If
            If PetIndexs(i) = IndexP Then
            UserList(UserIndex).Pet.Invocada = True
            UserList(UserIndex).Pet.Index = UserList(UserIndex).MascotasIndex(i)
            Npclist(UserList(UserIndex).MascotasIndex(i)).name = UserList(UserIndex).Pet.Nombre
            Npclist(UserList(UserIndex).MascotasIndex(i)).Stats.def = UserList(UserIndex).Pet.Defensa
            Npclist(UserList(UserIndex).MascotasIndex(i)).Stats.MaxHIT = UserList(UserIndex).Pet.MaxHIT
            Npclist(UserList(UserIndex).MascotasIndex(i)).Stats.MinHIT = UserList(UserIndex).Pet.MinHIT
            Npclist(UserList(UserIndex).MascotasIndex(i)).Stats.MinHP = UserList(UserIndex).Pet.MinHP
            Npclist(UserList(UserIndex).MascotasIndex(i)).Stats.MaxHP = UserList(UserIndex).Pet.MaxHP
        End If
...
Sub Cerrar_Usuario(ByVal UserIndex As Integer, Optional ByVal Tiempo As Integer = -1)
    ...
    If UserList(UserIndex).flags.UserLogged And Not UserList(UserIndex).Counters.Saliendo Then
        ...
        Else
            UserList(UserIndex).Counters.Salir = 15
        End If
        
        Call SendData(SendTarget.ToIndex, UserIndex, 0, "PRE50," & UserList(UserIndex).Counters.Salir)
    End If
End Sub
...
UserList(UserIndex).Pos.Map = CastilloEste Or UserList(UserIndex).Pos.Map = CastilloOeste Or _
UserList(UserIndex).Pos.Map = mapDuelo Then
    EstaEnCastillo = True
    Exit Function
End If
